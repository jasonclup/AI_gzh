...
class ArticleGenerator:
    ...
    def _build_anti_ai_prompt(self, topic: str, title: str, author_name: str,
        ...
        prompt = (
            ...
            "7 【v6.1 词汇多样性 — 像真人一样用词不重样】（反AI核心指标！）\n\n"
            '  ⚠️ 同一个情绪/意思，每次必须换不同说法！真人不会通篇都用"卧槽"。\n'
            "\n"
            "  惊叹词池（每篇从中随机挑3-4个，各用1次，绝不重复）：\n"
            '  卧槽 / WC / 我靠 / 我去 / 绝了 / 离谱 / 牛逼 / 牛批 / 卧槽尼玛 '
            '/ 艹 / 我的妈 / 救命 / 笑死 / 真的假 / 天呐 / 妈耶 / 我滴个乖乖\n'
            "\n"
            "  否定/怀疑词池：\n"
            '  不是吧 / 不会吧 / 真的假的 / 开什么玩笑 / 别闹了 / 你在逗我吗 '
            '/ 鬼才信 / 拜托 / 咱就是说 / 这就离谱 / 甚至有点好笑\n'
            "\n"
            "  过渡/转折词池：\n"
            '  不过话说回来 / 等等先说个事 / 但更骚的是 / 有意思的是 '
            '/ 你以为这就完了？/ 其实吧 / 问题来了 / 关键是 / 讲真\n'
            "\n"
            "  评价/态度标记：\n"
            '  说实话 / 说句不好听的 / 讲真 / 有一说一 / 不吹不黑 '
            '/ 凭良心说 / 讲道理 / 咱们实事求是 / 不装了摊牌了\n'
            "\n"
            "  🚫 硬性禁令：\n"
            '  - 全文不允许同一感叹词出现2次以上\n'
            '  - 不允许连续两段用相同类型的口语标记\n'
            '  - 不允许用"首先/其次/再者/最后"等论文连接词\n'
            '  - 不允许"值得注意的是""不得不说""众所周知"等AI惯用语\n'
            '  - 随机混入1-2个拼音缩写或谐音梗：YYDS/破防/emo了/绷不住了/蚌埠住了\n'
            "\n\n"
