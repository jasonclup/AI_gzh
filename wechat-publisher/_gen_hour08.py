# -*- coding: utf-8 -*-
"""Generate 08:00 hourly record and append to competitor analysis JSON"""
import json
    ...
    "hot_topics": [
        {
            ...
            "competitor_articles": [
                ...
                {"title": "AI写作年赚200万夫妻被封号，如何善用AI？", "account": "羊城晚报/YCWB", "publish_time": "2026-04-11T01:00:00+08:00", "estimated_reads": "5w+", "ai_score": 42, "ai_confidence": "medium", "ai_category": "suspected_ai_assisted", "ai_evidence": ["如何善用AI标准借热点+输出观点框架", "事件回顾部分与多家媒体报道高度雷同", "善用AI建议泛化缺乏具体实操案例", "过渡句值得注意的是/从这件事可以看到频率偏高"], "summary": "利用封号事件引出AI工具正确使用方法的观点文。事件回顾以信息整合为主，建议部分方向性指导但缺乏具体案例。", "url": "https://news.ycwb.com/ikimvkotjk/content_54056485.htm"},
            ...
            "analysis": {"title_patterns": "本轮三派：(1)讽刺型'搬起石头砸自己脚'(2)借力型'如何善用AI'(3)事实型'微信称反对'——第三类权威性最强", "content_structure": "事件类进入第二阶段——从'发生了什么'转向'意味着什么'", "image_style": "转向平台公告截图/被封界面截图/收入模式图表等证据图", "best_publish_window": "事件发酵48-72小时后深度分析黄金期", "ai_article_ratio": "33%", "ai_viral_features": ["人写爆款开始做数据核实(拆解200万构成)", "AI辅助仍停留于事件回顾+泛泛建议层面"]}
        },
        {
        ...
        },
        {
            ...
            "analysis": {"title_patterns": "外交类：(1)事实陈述型(央媒风) (2)深度分析型(问号制造悬念+关联大人物) (3)历史脉络型(折射出/背后的信号)", "content_structure": "时政类标准三段：通报事实→补充背景→延伸分析；第三段最容易AI化", "image_style": "外交部发布会现场图/蓝皮书封面/中日地图标注", "best_publish_window": "外交部记者会当日至晚间", "ai_article_ratio": "33%"}
        },
        {
            ...
            "competitor_articles": [
                ...
                {"title": "金正恩王毅握手拥抱背后的深意：蜜月期？还是战术性靠近？", "account": "国际观察类账号", "publish_time": "2026-04-11T08:00:00+08:00", "estimated_reads": "12w+", "ai_score": 75, "ai_confidence": "high", "ai_category": "likely_ai_generated", "ai_evidence": ["标题典型AI二元对立设问：蜜月期？还是战术性靠近？", "A或B设问方式是AI分析文标志性开头", "正文必然两边分析后得出折中结论", "缺乏真正的朝鲜问题专家访谈或内部消息源", "配图为通用外交握手照无独家素材"], "summary": "利用中朝高层互动热点制作的地缘政治分析。采用AI擅长的二元对立框架(A选项vs B选项)看似全面深入实则安全空泛。", "url": "https://world.huanqiu.com/article/4OVwIJSZeWE"}
            ],
            "analysis": {"title_patterns": "外交互动类：(1)标准通报式(官媒) (2)意义解读式(背后的深意/释放信号)——后者AI占比显著更高", "content_structure": "AI外交解读模板：描述场面→列举历史类似案例→分析A可能→分析B可能→折中结论", "best_publish_window": "外交活动当日傍晚至晚间", "ai_article_ratio": "33%"}
        },
        {
            ...
            "competitor_articles": [
                ...
                {"title": "从全红婵被网暴看体育饭圈化的危害与治理困境", "account": "体育评论自媒体", "publish_time": "2026-04-10T23:00:00+08:00", "estimated_reads": "10w+", "ai_score": 70, "ai_confidence": "high", "ai_category": "likely_ai_generated", "ai_evidence": ["标题宏大叙事'危害与治理困境'AI最爱学术包装", "结构模板化：案例引入→现象分析→原因探讨→治理建议", "饭圈化/网络暴力/综合治理术语堆砌", "建议泛泛(加强教育/完善法律/平台责任)无可操作性措施"], "summary": "利用网暴案件切入体育饭圈化议题。采用AI擅长的问题分析四段式模板表面系统全面实则空泛。", "url": ""}
            ],
            "analysis": {"title_patterns": "社会事件三阶段：(1)事实通报(警方风格) (2)舆论焦点(罚轻了) (3)宏大议题(看XX的XX与XX)——第3类几乎都是AI", "content_structure": "社会法治事件产业链：通报→跟进→反思；反思环节最容易AI化", "best_publish_window": "警方通报后2-6小时舆论发酵期", "ai_article_ratio": "33%"}
        },
        {
            "topic": "美伊停火谈判今日举行（伊朗代表团抵达伊斯兰堡）", "heat_level": "极高", "hot_value": 23338582,
            "source": "今日头条热搜",
            "competitor_articles": [
                {"title": "美伊同意停火并将于4月10日开启谈判伊朗公布十点计划", "account": "腾讯新闻", "publish_time": "2026-04-08T14:00:00+08:00", "estimated_reads": "25w+", "ai_score": 8, "ai_confidence": "high", "ai_category": "human_written", "ai_evidence": ["权威媒体突发新闻报道", "含伊朗最高国安委员会声明核心内容", "准确记录停火时间线(巴基斯坦斡旋→双方同意→谈判)", "信息密度高均为可核实一手信息 作为基础信源广泛转载"], "summary": "腾讯新闻关于美伊停火协议达成及即将开启谈判的突发报道。核心含伊朗十点停战计划要点及谈判安排最及时准确信息汇总。", "url": "https://news.qq.com/rain/a/20260408A03CGF00"},
            ...
            "analysis": {"title_patterns": "国际谈判类进化链：事实通报→筹备情况→悬念分析(AI浓度递增)；五大悬念/三大看点/X大关键是AI时政文最爱", "content_structure": "AI时政文终极模板：悬念引入→逐条分析(背景+现状+可能性A+可能性B+模糊总结)→宏观展望", "best_publish_window": "谈判开始前6-12小时前瞻最佳时段", "ai_article_ratio": "33%", "ai_viral_features": ["X大悬念/看点/关键列表式标题是AI时政文最强识别特征", "若文章用悬念作小标题前缀AI概率直接+30%"]}
        },
        {
            ...
            "competitor_articles": [
                ...
                {"title": "旧手机炼金热潮背后：电子垃圾回收的真相机遇与骗局", "account": "科普/财经类账号", "publish_time": "2026-04-11T10:00:00+08:00", "estimated_reads": "6w+", "ai_score": 62, "ai_confidence": "high", "ai_category": "likely_ai_generated", "ai_evidence": ["标题三段式宏大叙事'真相、机遇与骗局'AI科普标准包装", "借热门话题切入电子垃圾回收全景介绍", "必涵盖：现状数据→技术原理→市场规模→投资机会→风险提示", "据相关数据显示/业内人士指出模糊信源必然出现"], "summary": "借提炼黄金热点切入电子垃圾回收科普/分析。采用AI擅长借热点+全景扫描模式看起来信息量大实为公开资料重组。", "url": "https://news.online.sh.cn/news/gb/content/2026-04/11/content_10441219.htm"}
            ],
            "analysis": {"title_patterns": "科普辟谣类：(1)直击型(专家澄清真相) (2)快讯型(专家回应：XX) (3)借力型(XX背后：A与B与C)——第3类AI概率最高", "content_structure": "人写辟谣：提出传言→找专家否定→解释原因→给实用建议；AI模式：提出传言→扩展到整个行业→面面俱度分析→泛泛风险提示", "best_publish_window": "谣言传播高峰24小时内辟谣效果最佳", "ai_article_ratio": "33%"}
        },
        {
            "topic": "A股交易规则重大调整（ST股5%改10%+盘后交易全覆盖）", "heat_level": "高", "hot_value": 11589596,
            "source": "今日头条热搜",
            "competitor_articles": [
                {"title": "重磅！A股双规齐发重塑市场交易生态", "account": "CA Markets/财经号", "publish_time": "2026-04-07T14:00:00+08:00", "estimated_reads": "8w+", "ai_score": 76, "ai_confidence": "high", "ai_category": "likely_ai_generated", "ai_evidence": ["标题双规齐发/重塑生态AI式大词组合", "开场白AI金融文范本：资本市场史上又一个具有里程碑意义的日子", "正文完美AI模板：政策概述→条文解读→市场影响→投资者应对", "更公平更透明/关键少数/防护墙万能好评词堆砌", "引用北大教授田轩观点增权威感(AI常用名人背书法)", "约2500字无任何一条具体操作建议或持仓建议"], "summary": "A股新规实施当日综合分析。标题开篇极尽华丽之词逐条解读新规加泛泛市场影响。典型AI金融政策解读文看起来专业但无实战价值。", "url": "https://so.html5.qq.com/page/real/search_news?docid=70000021_03069d479c888252"},
        ...
        },
        {
            ...
            "source": "今日头条热搜",
            "competitor_articles": [
                {"title": "几毛钱一片的药被老外捧成减肥神药——黄连素海外走红调查", "account": "腾讯新闻/新快报", "publish_time": "2026-04-10T18:00:00+08:00", "estimated_reads": "20w+", "ai_score": 12, "ai_confidence": "high", "ai_category": "human_written", "ai_evidence": ["新快报记者原创调查报道", "揭示核心矛盾：国内几毛钱止泻药海外被包装成高端补充剂", "含TikTok实际传播情况和价格对比", "有医生权威提醒(不是天然司美格鲁肽)", "语言生动有趣老外捧成神药有反差感"], "summary": "新快报记者黄连素(小檗碱)海外爆火现象调查。核心亮点价格反差呈现(几毛钱vs海外高端补充剂)和医学界澄清——它不是天然司美格鲁肽。", "url": "https://news.qq.com/rain/a/20260410A07S5B00"},
            ...
            "analysis": {"title_patterns": "(1)反差型(几毛钱vs神药 人写爆款最爱) (2)警示型(专家不建议 实用导向) (3)升华型(反映了XX文化心理 AI爱的小题大做)", "content_structure": "人写健康文：现象呈现→价格对比→医生提醒；AI文：现象→文化分析→趋势预判→宏大总结", "best_publish_window": "话题登上热榜当日", "ai_article_ratio": "33%"}
        },
        {
            ...
            "competitor_articles": [
                ...
                {"title": "南海博弈新变局：菲律宾油气困局与中国战略抉择", "account": "地缘政治分析号", "publish_time": "2026-04-11T09:00:00+08:00", "estimated_reads": "6w+", "ai_score": 74, "ai_confidence": "high", "ai_category": "likely_ai_generated", "ai_evidence": ["标题AI味浓：新变局/困局/战略抉择三连大词组合", "结构可预见：菲困境描述→中国选项分析→地区影响→未来预判", "博弈/棋局/牌面等地缘政治隐喻滥用", "对中国战略抉择分析必两面平衡(既不能太软也不能太硬)"], "summary": "利用南海油气合作热点制作地缘政治分析。采用博弈-困局-抉择经典叙事看似深刻辩证实则安全平庸。AI地缘分析代表样本。", "url": "https://sputniknews.cn/20260330/1070505805.html"}
            ],
            "analysis": {"title_patterns": "地缘政治：(1)专家署名型(有人名机构背书 人写) (2)紧迫叙事型(紧急/急求 人机混合) (3)博弈分析型(新变局/战略抉择 AI重灾区)", "content_structure": "AI地缘永恒公式：各方利益梳理→力量对比分析→情景推演(乐观/基准/悲观)→稳妥结论", "best_publish_window": "相关外交动向公布当日", "ai_article_ratio": "33%"}
        }
    ],
    "daily_summary": {
        ...
        "key_findings": [
            "[AI评分新高] 本轮最高78分——美伊世纪谈判：五大悬念牵动全球能源格局 X大悬念/看点列表式确认为AI时政文最强识别特征",
            "[新AI变种] 二元对立设问标题模式(蜜月期？还是战术性靠近？)：AI通过构造虚假二选一来制造深度错觉",
            "[AI金融文新招] 名人背书法——引用真实学者姓名+泛泛观点增加可信度 本轮A股新规文出现引用北大教授案例",
            "[小题大做模式确认] AI倾向于将有趣小现象强行上升到理论高度(黄连素→文化心理与国际趋势)",
...
print(f"SUCCESS! Hourly record 08 appended.")
print(f"Total hourly records now: {len(data['hourly_records'])}")
print(f"This hour: {len(hourly_08['hot_topics'])} topics, {hourly_08['daily_summary']['total_articles_collected']} articles")
